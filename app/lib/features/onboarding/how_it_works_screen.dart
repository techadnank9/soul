...
class _HowItWorksScreenState extends State<HowItWorksScreen> {
  static const _steps = [
    ...
    'A line comes back holding something you said',
    'Look closer if you want, and decide what to do',
    'It asks how that went, and what keeps returning becomes a pattern',
  ];
