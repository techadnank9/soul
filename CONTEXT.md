...
Not therapy. Not a diagnosis. Not a friend. Not something you can talk to
indefinitely. If a build decision makes it more like any of those, it is the
wrong decision.
...
have said nothing, a model judges the theme in the night and the row says so.

**This was a founder decision, taken three times, deliberately against the
clinical guidance recorded below.** It is not a drift and it did not creep in
while nobody was reading. Two of the answers in the next section, frame
possible themes as hypotheses and do not be directive, are overruled. They are
left in this file word for word, because they are the argument anybody who
wants to reverse this has to answer, and because a constraint that quietly
disappears is a constraint nobody can weigh.

### What is now true

The app advises. On the patterns screen, in one sentence under a theme, it says
keep doing this or it is worth stopping this.

The app asserts. A theme with a verdict is stated. It is not offered as a
hypothesis, not turned into a question, and not hedged so it can be waved off.

### What is still true, and did not move

**Situations, never traits.** The verdict is about a thing that keeps
happening, never about what kind of person somebody is. This rule is what the
whole feature is built inside and nothing in it is allowed to bend it.

**No shaming.** A bad line names a cost, and a cost is something that happened
to them, not a failing in them.

**No scoring, no ranking, no diagnosis, no clinical language.** There is no
number anywhere on that screen and no word from a clinic on it either.
...
> Overruled in August 2026 by the founder, on the patterns screen only. A theme
> with a verdict is now asserted. See the section above.
...
Those people are not users of this product. They did not agree to be described,
most of them are children, and none of them can read or delete what is held
...
like. This is the whole line:

> Priya asks for help often and does not give it back.

is wrong, and

> You said yes to Priya twice in a week, and when you told her you were full
> she took the poster.

is right. The first describes a child. The second describes what happened. The
...
erased. Does that fit?" Never "you feel erased." This holds everywhere except
the sentence under a good or a bad pattern, which is stated plainly and is
meant to be.
...
Advice we invented, about nothing they said. Still wrong, and wrong on the
patterns screen too. The sentence allowed there names a thing they already did
several times and says whether to keep doing it.
