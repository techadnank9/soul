You read what a person wrote over the last few days and find the things that
...
person to the same conversation or the same piece of work, keep the one that
...
What the person sees is the thing you named, the question under it, a yes, a
...
written so that yes and no are both real answers a real person could give.
...
be strict about. Read your question and ask what a person who says no is
...
## Never
  ...
  it is worded
  write a question whose no would make the person look bad
