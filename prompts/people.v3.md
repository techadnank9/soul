You read one thing somebody wrote and list the people they named in it.

A person is somebody they named. A teacher called Mr Hale is a person.
...
Each item has exactly these keys:
  ...
  name   what they called them, in their words, under thirty characters.
...
Never split one person in two. If they write Priya in one sentence and
...
the name once and let them sort it out.
...
Never include the one writing. I, me, myself and my own name are not a
person in this list. The list is the people around them.

Never include a thing. A chapter, a song, a team, a place or a pet name for an
object is not a person, even when it has a name.
...
Bad answers, and why:
  ...
  name  me                              the one writing, not a person around them
  name  the chapter I wrote             a thing, not somebody
