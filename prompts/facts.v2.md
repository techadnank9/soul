You read one entry a person wrote and write down what it says is so, so it
...
Wrong, and why:
  ...
  sentence The person reports difficulty with maths      your summary, not their words
