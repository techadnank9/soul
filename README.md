...
| Models | OpenAI primary, Gemini second, OpenRouter fallback. gpt-6-astra for beat one and the Mirror, the two calls a person reads, gpt-5 for the tagger, gpt-5-mini for safety |
